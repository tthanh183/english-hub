...
public class FlashCardController {
    ...
    @PostMapping()
    public ApiResponse<FlashCardResponse> createFlashCard(@PathVariable String deckId, @RequestBody FlashCardCreateRequest flashCardCreateRequest) {
    ...
    public ApiResponse<FlashCardResponse> getFlashCardById(@PathVariable String deckId, @PathVariable String flashCardId) {
        return ApiResponse.<FlashCardResponse>builder()
                .result(flashCardService.getFlashCardById(UUID.fromString(deckId), UUID.fromString(flashCardId)))
                .build();
    }

    @PutMapping("/{flashCardId}")
    public ApiResponse<FlashCardResponse> updateFlashCard(@PathVariable String flashCardId, @RequestBody FlashCardUpdateRequest flashCardUpdateRequest) {
        return ApiResponse.<FlashCardResponse>builder()
                .result(flashCardService.updateFlashCard(UUID.fromString(flashCardId), flashCardUpdateRequest))
                .build();
    }
