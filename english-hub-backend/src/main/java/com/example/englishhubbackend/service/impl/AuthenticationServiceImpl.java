...
public class AuthenticationServiceImpl implements AuthenticationService {
    ...
    private void sendVerificationEmail(User user) {
        ...
        String frontendUrl = "http://localhost:5174/verfiy";
        String verificationLink = frontendUrl + "?email=" + user.getEmail() + "&code=" + user.getVerificationCode();
        String htmlMessage = "<html>"
                ...
                + "<p style=\"font-size: 16px; text-align: center; color: #555;\">Please click the link below to verify your email address:</p>"
                + "<div style=\"background-color: #f1f1f1; padding: 20px; border-radius: 5px; margin-top: 20px; text-align: center;\">"
                + "<a href=\"" + verificationLink + "\" style=\"font-size: 20px; font-weight: bold; color: #007bff; text-decoration: none;\">Click here to verify your email</a>"
                + "</div>"
