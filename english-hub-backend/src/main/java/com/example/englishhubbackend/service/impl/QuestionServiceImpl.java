...
public class QuestionServiceImpl implements QuestionService {
    ...
    public Question createQuestionEntity(QuestionCreateRequest questionCreateRequest) {
        QuestionType questionType = questionTypeService.
                getQuestionTypeEntityByDescription(questionCreateRequest.getQuestionType());
        ...
        if (questionType.getName().equals(QuestionTypeEnum.PART_1_PHOTOGRAPHS.name()) ||
            ...
            ListeningQuestion listeningQuestion = questionMapper.toListeningQuestion(questionCreateRequest);
